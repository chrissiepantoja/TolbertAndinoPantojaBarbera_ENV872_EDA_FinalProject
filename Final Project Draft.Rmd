...
event during 2024 qualifies as an 18-year event. This means there was 
approximately a 20% probability of such an event occurring in any given year.
...
I would like to be tell visually how unusual Helene was for each
site. I will create a map that ties the magnitutude of the Hazen interval,
that is, how unusual the Helene event was, to the size of the dot on the map.
The larger the dot, the less likely that even was to occur.
```{r}
...
I go and download more sites in Western NC, selecting sites that have
all of our the three parameters available. There is a limited number.
...
We could call this a map of relative intensity to historical norms. While the 
size of the dots don't map the absolute
intensity of precipitation or flooding, they do indicate the magntitude of
those parameters in relation to the historical norms of each area.
Flooding infrastructure is often calibrated to 50 year or 75
year storms, so the relative magntiude to historical norms is important for
measuring how much the calibrated infrastructure was overwhelmed (or resiliant to)
Helene. While our sites that contain all three paramters are limited,
we can see that Helene's relative intensity to historical norms was greater in a
path throuh central Western NC, particularly over Ashveille. We can reasonably
assume then that Asheville's infrastructure was more inundated than that of NE
NC or other sites listed.
